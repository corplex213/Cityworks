        ...
        <div class="bg-slate-700 p-3 flex flex-wrap items-center justify-between gap-2">
            ...
            <div class="flex items-center gap-2">
                ...
                <div class="flex gap-1">
                    ...
                    >All</button>
                    <button class="task-filter px-2 py-1 text-xs rounded bg-slate-600 hover:bg-blue-600 text-white"
                        data-filter="ongoing"
                        title="Show only ongoing tasks"
                    >Ongoing</button>
                    <button class="task-filter px-2 py-1 text-xs rounded bg-slate-600 hover:bg-green-600 text-white"
                        data-filter="completed"
                        title="Show only completed tasks"
                    >Completed</button>
                    <button class="task-filter px-2 py-1 text-xs rounded bg-slate-600 hover:bg-red-600 text-white"
            ...
            <div class="flex items-center gap-2">
                ...
                <button 
                    id="export-pdf-btn"
                    title="Export the current page as PDF"
                    class="px-3 py-2 bg-slate-500 hover:bg-slate-600 text-white rounded text-xs transition"
                >
            ...
            <div id="sidebar-content">
                ...
                <div class="mb-6">
                    <button id="toggle-my-tasks"
                        class="flex items-center w-full text-left text-white font-semibold mb-2 focus:outline-none"

...
class CalendarController extends Controller
{
    ...
    public function events(Request $request)
    {
        ...
        $taskQuery = Task::with(['assignedUser', 'project'])
        ...
        } // else - all users' tasks will be fetched
        ...
        [
            ...
            'end' => '2025-05-15',
            'display' => 'background',
            'className' => 'bg-bar-red', // Add a CSS class for color
        ],
        [
            'id' => 'bg-2',
            'start' => '2025-05-18',
        ...
        // Merge and return
    $allEvents = $backgroundEvents->merge($taskEvents)->merge($calendarEvents)->values();

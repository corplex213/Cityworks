...
class CalendarController extends Controller
{
    ...
    {
        $this->middleware('permission:view tasks')->only(['index', 'events', 'getUsers']);
    }
    ...
    public function events(Request $request)
    {
        ...
        if ($userFilter === 'mine' || (is_numeric($userFilter) && $userFilter == $user->id)) {
        ...
        // Merge and return
        $allEvents = collect($taskEvents)->merge(collect($calendarEvents))->values();

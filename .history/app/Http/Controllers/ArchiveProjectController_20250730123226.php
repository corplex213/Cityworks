...
class ArchiveProjectController extends Controller
{
    ...
    public function bulkDelete(Request $request)
    {
        ...
        $projects = Project::whereIn('id', $ids)->where('archived', true)->get();
        ...
        return redirect()->route('archiveProjects')->with('success', 'Selected archived projects deleted successfully.');
    }
}
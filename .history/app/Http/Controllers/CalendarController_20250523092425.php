...
class CalendarController extends Controller
{
    ...
    {
        \Log::info('CalendarController@store called', ['request' => $request->all()]);
        ...
        try {
            ...
            $task = Task::create([
                ...
                // Add other fields as needed (status, project_id, etc.)
            ]);
            ...
            \Log::error('Error in CalendarController@store', [
                'error' => $e->getMessage(),

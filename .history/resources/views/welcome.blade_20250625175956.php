                    ...
                    <div class="bg-white rounded-lg shadow-lg p-8">
                        <div class="space-y-6">
                            <div>
                                ...
                                <p class="mt-2 text-neural-600">Jose Felipe St., Motorpool Compound, Lower Rock Quarry</p>
                            </div>
                            <div>
                            ...
                            <div>
                                <h3 class="font-semibold text-neural-900">Department Head</h3>
                                <p class="mt-2 text-neural-600">Engr. Richard Benjamin L. Lardizabal</p>
                                <p class="mt-2 text-neural-600">Acting City Engineer</p>
                            </div>
                        </div>
                    </div>
                </div>

                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg h-full flex flex-col justify-between">
                        <div class="p-8 h-full flex flex-col justify-between">
                            <h3 id="recent-activities-header" class="text-lg font-medium text-gray-900 dark:text-white mb-4">Recent Activities</h3>
                            <div class="space-y-4">
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg h-full flex flex-col">
                        <div class="flex-1 flex flex-col p-8">
                            <h3 id="upcoming-deadlines-header" class="text-lg font-medium text-gray-900 dark:text-white mb-6">Upcoming Deadlines</h3>
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg h-full flex flex-col justify-between">
                        <div class="p-8 h-full flex flex-col justify-between">
                            <div class="flex justify-between items-center mb-10">
                                <h3 class="text-lg font-medium text-gray-900 dark:text-white">Project Status</h3>
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg h-full flex flex-col justify-between">
                        <div class="p-8 h-full flex flex-col justify-between">
                            <div class="flex justify-between items-center mb-4">
                                <h3 class="text-lg font-medium text-gray-900 dark:text-white">Project Types</h3>
                                <div class="flex space-x-2">

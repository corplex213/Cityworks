<x-app-layout>
    @vite(['resources/css/project-management.css', 'resources/js/project-management.js'])
    <x-slot name="header">
                ...
                <div id="sortBtnContainer">
                    ...
                    >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M3 10a1 1 0 002 0v4h2l-3 3-3-3h2v-4zm14-1a1 1 0 00-2 0v4h-2l3 3 3-3h-2v-4z" clip-rule="evenodd" />
                        </svg>
                        Sort
                    </button>
                </div>
...
<script src="/build/frontend/js/kanban.js"></script>
<script src="/build/frontend/js/activity-log.js"></script>
<script src="/build/frontend/js/sorting.js"></script>
<script src="/build/frontend/js/view-switch.js"></script>
<script src="/build/frontend/js/task-table.js"></script>
<script src="/build/frontend/js/task-drawer.js"></script>
<script src="/build/frontend/js/subtasks.js"></script>
</x-app-layout>
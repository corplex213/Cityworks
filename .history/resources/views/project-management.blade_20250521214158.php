                ...
                <div class="p-4 h-full flex flex-col">
                    ...
                    <div class="bg-gray-800 p-4 rounded-lg mb-4">
                        <p class="text-gray-300">
                            <strong>Start Date:</strong> <span id="startDate" class="text-gray-300"></span> | 
                            <strong>Due Date:</strong> <span id="dueDate" class="text-gray-300"></span>
                        </p>
                        <p class="text-gray-300">
                            <strong>Priority:</strong> <span id="priority" class="text-gray-300"></span> | 
                            <strong>Status:</strong> <span id="status" class="text-gray-300"></span>
                        </p>
                        <p class="text-gray-300">
                            <strong>Assigned by:</strong> <span id="assignedBy" class="text-gray-300"></span> | 
                            <strong>Assigned to:</strong> <span id="assignedToName" class="text-gray-300"></span>
                        </p>
                        <p id="assignmentTimestamp" class="text-gray-300"><strong>Assigned on:</strong> <span class="text-gray-300"></span></p>

<x-app-layout>
    @vite(['resources/css/project-management.css', 'resources/js/activityLog.js', 'resources/js/sortingTask.js', 'resources/js/project-managementUI.js', 'resources/js/managementCRUD.js', 'resources/js/project-table.js', 'resources/js/taskDrawer.js'])
    <x-slot name="header">

<x-app-layout>
    @vite(['resources/css/project-management.css', 'resources/js/activityLog.js', 'resources/js/sortingTask.js'])
    <x-slot name="header">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-full max-w-md p-6">
            ...
            <form id="sortingForm">
                ...
                <div class="flex items-center space-x-4 mt-2 mb-4">
                    <label class="flex items-center text-white"> <!-- Add text-white -->

                    ...
                    <div id="taskDetailsContent" class="flex-1 overflow-y-auto space-y-6">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="space-y-4">
                                        ...
                                        <div class="flex items-start space-x-3">
                                            ...
                                            <div class="flex-grow">
                                                <div class="relative">
                                                    <textarea 
                                                    id="newComment" 
                                                    class="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-blue-50 dark:bg-gray-700 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none" 
                                                    rows="3"
                                ...
                                <!-- Comments List - Updated with matching background color and added spacing -->
                                <div id="commentsContainer" class="bg-blue-50 dark:bg-gray-700 rounded-lg shadow-sm p-4 border border-gray-200 dark:border-gray-600 mt-6 space-y-4">

...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class = "scroll-smooth">
    ...
    <body class="bg-gray-100">
        ...
        <nav id="navbar" class="bg-transparent fixed w-full z-50 transition-all duration-300 -translate-y-full opacity-0">
    ...
    window.addEventListener("scroll", function() {
        ...
        if (window.scrollY > 50) {
            navbar.classList.remove("-translate-y-full", "opacity-0", "bg-transparent");
            navbar.classList.add("bg-white", "shadow-md", "opacity-100", "translate-y-0");
        } else {
            navbar.classList.add("-translate-y-full", "opacity-0", "bg-transparent");
            navbar.classList.remove("bg-white", "shadow-md", "opacity-100", "translate-y-0");
        }
    });
</script>
</html>
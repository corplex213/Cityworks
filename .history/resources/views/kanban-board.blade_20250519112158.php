    ...
    // Render fields as labeled rows (except status)
        ...
        fieldsDiv.innerHTML = `
            <div class="flex justify-between items-center">
                <span class="text-xs text-gray-400">Numbers</span>
                <span class="text-sm text-gray-200">${task.numbers ?? ''}</span>
            </div>
            <div class="flex justify-between items-center">
            ...
            <div class="flex justify-between items-center">
                ...
                <span class="text-sm text-gray-200">${task.subtasks ? task.subtasks.length : 0}</span>
            </div>
        `;

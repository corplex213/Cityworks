                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                @foreach($users as $user)
                                    <div class="bg-gray-700 rounded-lg p-6 border border-gray-600 hover:border-gray-500 transition duration-200"
                                        x-data="{ open: true }">
                                        ...
                                        <div class="mt-4" x-show="open" x-transition>
                                            {{-- ...existing task info here... --}}
                                            <!-- (No changes needed inside this block) -->

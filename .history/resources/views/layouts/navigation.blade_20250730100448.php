    ...
    <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:space-x-4 sm:ms-6">
                ...
                <!-- Settings Dropdown -->
                <div class="absolute right-0 mt-2 w-72 flex items-center">
                    <x-dropdown align="left" width="80">
                        ...
                        <x-slot name="content">
                            <div class="py-2 px-4 w-72">
                                <!-- User Info -->
                                <div class="flex items-center space-x-3 px-2 py-2 border-b border-gray-200 dark:border-gray-700 mb-2">
                                    <div class="flex-shrink-0 h-10 w-10 rounded-full bg-blue-600 dark:bg-blue-900 flex items-center justify-center text-lg font-bold text-white">
                                        {{ strtoupper(substr(Auth::user()->name, 0, 1)) }}
                                    </div>
                                    <div class="min-w-0">
                                        <div class="font-semibold text-gray-900 dark:text-gray-100 truncate max-w-[10rem]">{{ Auth::user()->name }}</div>
                                        <div class="text-xs text-gray-500 dark:text-gray-400 truncate max-w-[10rem]">{{ Auth::user()->email }}</div>
                                    </div>
                                </div>

                                <!-- Settings Links -->
                                <div class="flex flex-col space-y-1">
                                    <x-dropdown-link :href="route('profile.edit')" class="flex items-center gap-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded px-2 py-2 transition">
                                    ...
                                    @role('administrative')
                                    <x-dropdown-link :href="route('personnel')" class="flex items-center gap-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded px-2 py-2 transition">
                                        <svg class="h-5 w-5 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                        ...
                                        <span class="truncate">{{ __('Personnel') }}</span>
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="route('userAccessControl')" class="flex items-center gap-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded px-2 py-2 transition">
                                        <svg class="h-5 w-5 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 11c0-1.657 1.343-3 3-3s3 1.343 3 3-1.343 3-3 3-3-1.343-3-3zm0 0V7m0 4v4m0 0a9 9 0 11-6.364-2.636" />
                                        </svg>
                                        <span class="truncate">{{ __('User Access Control') }}</span>
                                    </x-dropdown-link>
                                    @endrole
                                </div>
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <x-dropdown-link :href="route('logout')" class="flex items-center gap-2 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900 rounded px-2 py-2 transition"

            ...
            <div class="hidden sm:flex sm:items-center sm:space-x-4 sm:ms-6">
                ...
                <div class="flex items-center">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <div class="py-2 px-2 w-56">
                                <!-- User Info -->
                                <div class="flex items-center space-x-3 px-2 py-2 border-b border-gray-200 dark:border-gray-700 mb-2">
                                    <div class="flex-shrink-0 h-10 w-10 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center text-lg font-bold text-blue-700 dark:text-blue-300">
                                ...
                                <div class="flex flex-col space-y-1">
                                    ...
                                    @role('administrative')
                                    <x-dropdown-link :href="route('personnel')" class="flex items-center gap-2">
                                        <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                    ...
                                    <x-dropdown-link :href="route('userAccessControl')" class="flex items-center gap-2">
                                        <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">

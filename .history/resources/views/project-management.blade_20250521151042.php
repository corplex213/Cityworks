<x-app-layout>
    ...
    <div id="projectOverviewSection" class="bg-gray-50 dark:bg-gray-900 p-6 rounded-lg shadow-lg mx-6 lg:mx-12" style="margin-left: 0px;margin-right: 0px;">
        ...
        <section id="mainTableSection" class="group-section mt-8">
            ...
            <!-- Task Details Drawer -->
            <div id="taskDetailsDrawer" class="fixed inset-y-0 right-0 w-full sm:w-1/2 bg-gray-900 dark:bg-gray-950 shadow-lg transform translate-x-full transition-transform duration-200 ease-out z-50" data-current-user-id="{{ auth()->id() }}">

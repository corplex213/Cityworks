...
<template id="taskCardTemplate">
    <div class="task-card bg-white dark:bg-gray-700 rounded-lg shadow p-4 cursor-move" draggable="true">
        ...
        <div class="subtasks-list mt-2 hidden">
            <button class="add-kanban-subtask-btn text-xs text-green-600 hover:underline flex items-center mt-2" type="button">
...
function createTaskCard(task) {
    ...
    addBtn.className = 'add-kanban-subtask-btn text-xs text-green-600 hover:underline flex items-center mt-2';
    addBtn.type = 'button';

<x-app-layout>
    ...
    <div class="p-6 h-full flex flex-col">
        ...
        <div id="taskDetailsContent" class="flex-1 overflow-y-auto space-y-6">
            ...
            <!-- Tabs Navigation -->
            <div class="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-750 rounded-t-lg pt-2 px-2">
            ...
            <div class="tab-content">
                <!-- Comments Tab -->
                <div id="commentsTabContent" class="tab-pane active bg-gray-50 dark:bg-gray-750 p-4 rounded-b-lg">
                    <div class="space-y-4">
                        <!-- Comment Input -->
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 border-l-4 border-blue-400 dark:border-blue-600">
                        ...
                        <!-- Comments List -->
                        <div id="commentsContainer" class="space-y-4 bg-gray-100 dark:bg-gray-700 p-4 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <!-- Files Tab -->
                <div id="filesTabContent" class="tab-pane hidden bg-gray-50 dark:bg-gray-750 p-4 rounded-b-lg">
                    <div class="space-y-4">
                        <!-- File Upload Area -->
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 border-l-4 border-green-400 dark:border-green-600">
                        ...
                        <!-- Files List -->
                        <div id="fileList" class="space-y-2 bg-gray-100 dark:bg-gray-700 p-4 rounded-lg border border-gray-200 dark:border-gray-600">

<x-app-layout>
    ...
    <div id="projectOverviewSection" class="bg-gray-50 dark:bg-gray-900 p-6 rounded-lg shadow-lg mx-6 lg:mx-12" style="margin-left: 0px;margin-right: 0px;">
        ...
        <section id="mainTableSection" class="group-section mt-8">
            ...
            <!-- Task Details Drawer -->
            <div id="taskDetailsDrawer" class="fixed inset-y-0 right-0 w-full sm:w-1/2 bg-gray-800 dark:bg-gray-850 shadow-lg transform translate-x-full transition-transform duration-200 ease-out z-50" data-current-user-id="{{ auth()->id() }}">
                <div class="p-4 h-full flex flex-col">
                    <!-- Drawer Header -->
                    <div class="flex justify-between items-center mb-4 pb-2 border-b border-gray-700">
                        <h3 id="taskTitle" class="text-xl font-semibold text-white"></h3>
                    ...
                    <div class="bg-gray-800 p-4 rounded-lg mb-4">
                        <p class="text-gray-300"><strong>Start Date:</strong> <span id="startDate" class="text-gray-300"></span></p>
                        <p class="text-gray-300"><strong>Due Date:</strong> <span id="dueDate" class="text-gray-300"></span></p>
                        <p class="text-gray-300"><strong>Priority:</strong> <span id="priority" class="text-gray-300"></span></p>
                        <p class="text-gray-300"><strong>Status:</strong> <span id="status" class="text-gray-300"></span></p>
                        <p id="completionTimestamp" class="text-gray-300 hidden"><strong>Completed on:</strong> <span class="text-gray-300"></span></p>
                    </div>
                                        ...
                                        <div class="flex items-start space-x-3">
                                            ...
                                            <div class="flex-grow">
                                                <div class="relative">
                                                    <textarea 
                                                    id="newComment" 
                                                    class="w-full p-3 border border-gray-600 rounded-lg bg-gray-700 text-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none" 
                                                    rows="3"

                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium flex space-x-2">
                                            <!-- Existing role select and assign role button -->
                                            <form method="POST" action="{{ route('user-access.assign-role', $user->id) }}">
                                                @csrf
                                                ...
                                                <button type="submit" class="ml-2 text-blue-600 hover:text-blue-900">Assign Role</button>
                                            </form>

                                            <!-- Edit User Button -->
                                            <a href="{{ route('profile.edit', $user->id) }}" class="text-yellow-500 hover:text-yellow-700 ml-2">Edit</a>

                                            <!-- Delete User Button -->
                                            <form method="POST" action="{{ route('profile.destroy', $user->id) }}" onsubmit="return confirm('Are you sure you want to delete this user?');">
                                                @csrf
                                                @method('DELETE')

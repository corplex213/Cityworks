        ...
        while (nextRow && nextRow.classList.contains('subtask-row')) {
            ...
            if (isSubtaskChanged && subtaskId) {
                ...
                if (subtaskBudgetValue !== Number(subtaskBudgetInput.getAttribute('data-old-value') || 0) && 
                    ...
                    const oldBudgetValue = parseFloat(parseFloat(subtaskBudgetInput.getAttribute('data-old-value') || 0).toFixed(2));
                    const newBudgetValue = parseFloat(subtaskBudgetValue.toFixed(2));
                    if (oldBudgetValue !== newBudgetValue) {
                        changes.budget = {

...
function formatMentions(text) {
    ...
    // This pattern will look for @username and color just the username part
    const processed = safeText.replace(/@([a-zA-Z0-9 ]+)(\s|$|\b)/g, function(match, username, terminator) {
        return `<span class="text-blue-500 dark:text-blue-400">@${username}</span>${terminator}`;
    });

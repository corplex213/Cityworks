...
function formatMentions(text) {
    ...
    // Process the content with mentions
    // This regex matches @username patterns followed by a space or at end of text
    // Wrap only the @username part in blue span, not the subsequent text
    return safeText.replace(/@([a-zA-Z0-9 ]+)(\s|$|\b)/g, '<span class="text-blue-500 dark:text-blue-400">@$1</span>$2');
}

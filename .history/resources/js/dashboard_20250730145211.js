...
document.addEventListener('DOMContentLoaded', function() {
        ...
        tippy('#task-completion', {
            content: 'Shows the percentage of tasks that have been completed out of all tasks.',
            placement: 'top',
            theme: 'light-border',
            animation: 'scale',
            arrow: true,
        ...
        tippy('#activity-status', {
            content: 'Visual summary of project statuses (In Progress, Completed, Deferred) and their proportions.',
            placement: 'top',
            theme: 'light-border',
            animation: 'scale',
            arrow: true,
        ...
        tippy('#activity-types', {
            content: 'Breakdown of activities by type (e.g., POW, Investigation, MTS, etc.) to help you see the distribution of work.',
            placement: 'top',
            theme: 'light-border',
            animation: 'scale',
            arrow: true,
        ...
        tippy('#task-priorities', {
            content: 'Shows the distribution of tasks by priority level (High, Normal, Low) to help you focus on urgent work.',
            placement: 'top',
            theme: 'light-border',
            animation: 'scale',
            arrow: true,
        ...
        tippy('#task-status', {
            content: 'Displays how tasks are distributed by their current status (Completed, For Checking, For Revision, Deferred).',
            placement: 'top',
            theme: 'light-border',
            animation: 'scale',
            arrow: true,
        ...
        tippy('#task-priority-trends-header', {
            content: 'Shows how the distribution of task priorities (High, Normal, Low) changes over time.',
            placement: 'top',
            theme: 'light-border',
            animation: 'scale',
            arrow: true,
        ...
        tippy('#task-status-trends-header', {
            content: 'Displays how the status of tasks (Completed, For Checking, For Revision, Deferred) evolves over time.',
            placement: 'top',
            theme: 'light-border',
            animation: 'scale',
            arrow: true,

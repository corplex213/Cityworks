...
function formatMentions(text) {
    ...
    // Then replace all @mentions with highlighted spans
    return safeText.replace(/@([a-zA-Z0-9 ]+)/g, '<span class="font-bold text-blue-500 bg-blue-500/10 dark:bg-blue-900/30 dark:text-blue-300 px-1 rounded">@$1</span>');
}

...
function createTaskCard(task) {
    ...
    taskCard.addEventListener('click', () => {
        openTaskDetailsFromKanban(task);
    });
...
function addKanbanTask(userId, statusKey) {
    ...
    // --- Use the same form as Add Subtask ---
    const form = document.createElement('form');
    ...
    form.innerHTML = `
        <input type="text" class="subtask-title-input w-full p-2 rounded border bg-gray-900 text-white placeholder-gray-400" placeholder="Subtask name" required>
        <input type="date" class="subtask-start-date-input w-full p-2 rounded border bg-gray-900 text-white placeholder-gray-400" placeholder="Start Date">
        <input type="date" class="subtask-due-date-input w-full p-2 rounded border bg-gray-900 text-white placeholder-gray-400" placeholder="Due Date">
        <select class="subtask-priority-input w-full p-2 rounded border bg-gray-900 text-white">
            <option value="High">High</option>
            <option value="Normal" selected>Normal</option>
            <option value="Low">Low</option>
        </select>
        <input type="text" class="subtask-budget-input w-full p-2 rounded border bg-gray-900 text-white placeholder-gray-400" placeholder="Budget" inputmode="decimal">
        ${window.projectType === 'POW' ? `
        <div>

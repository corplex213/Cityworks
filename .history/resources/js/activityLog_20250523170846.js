function loadActivityLog() {
        ...
        fetch(`/projects/${projectId}/activities`)
            ...
            .then(data => {
                console.log("Activity data received:", data); // Debug output
    ...
    function createActivityElement(activity) {
        return `
            <div class="bg-white dark:bg-gray-700 rounded-lg shadow p-4 mb-4" data-type="${activity.type}">
                <div class="flex items-start">
                    <div class="flex-grow">
                        <div class="text-gray-700 dark:text-gray-200 break-words whitespace-normal" style="word-break: break-word; overflow-wrap: break-word;">
                            ${activity.formatted_message || "Activity details not available"}
                        </div>

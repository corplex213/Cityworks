...
// Function to create table for a user with their tasks
    function createTableForUser(userName, userId, tasks) {
        ...
        const saveButton = document.createElement('button');
            saveButton.className = 'flex items-center text-green-500 hover:text-green-700 font-semibold mr-2 transition-colors duration-150';
            ...
            deleteButton.className = 'flex items-center text-red-500 hover:text-red-700 font-semibold transition-colors duration-150';

function loadActivityLog() {
    ...
    function createActivityElement(activity) {
        ...
        // Spatie logs changed attributes in properties.attributes and old values in properties.old
                ...
                if (old[key] !== undefined && old[key] !== attrs[key]) {
                    changesHtml += `
                        <div class="flex items-center text-sm text-gray-600 dark:text-gray-300">
                            ...
                            <span class="line-through text-red-400 mr-1">"${old[key]}"</span>
                            ...
                            <span class="text-green-500 font-semibold">"${attrs[key]}"</span>
                        </div>
                    `;
                } else {
                    changesHtml += `

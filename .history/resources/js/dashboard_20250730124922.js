...
document.addEventListener('DOMContentLoaded', function() {
        tippy('#total-projects-card', {
            content: 'Shows the total number of activities in the system, including all statuses. The percentage indicates the change in new projects created this week compared to last week.',
            placement: 'top',
            theme: 'light-border',
            animation: 'scale',
            arrow: true,
        ...
        tippy('#in-progress-card', {
            content: 'Projects that are currently in progress. The percentage shows the change in new in-progress projects created this week vs. last week.',
            placement: 'top',
            theme: 'light-border',
            animation: 'scale',
            arrow: true,
        ...
        tippy('#completed-card', {
            content: 'Projects that have been completed. The percentage shows the change in completed projects this week vs. last week.',
            placement: 'top',
            theme: 'light-border',
            animation: 'scale',
            arrow: true,
        ...
        tippy('#deferred-card', {
            content: 'Projects that have been deferred or put on hold. The percentage shows the change in deferred projects this week vs. last week.',
            placement: 'top',
            theme: 'light-border',
            animation: 'scale',
            arrow: true,
